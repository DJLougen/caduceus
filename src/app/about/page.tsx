      ...
      <div className="max-w-3xl mx-auto px-4 pt-8 pb-16">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-[#999] leading-relaxed">
            ...
            <p>
              Every task in Caduceus comes from real production scenarios, generated by the OpsFlight simulator.
              These aren&apos;t toy problems — they&apos;re the kind of multi-step debugging and operations tasks that
              actually determine whether an agent is production-ready.
            </p>

            <h2 className="font-[family-name:var(--font-heading)] text-xl font-bold text-[#F5F5F5] mt-10 mb-3">
              Connection to Harmonic & OpsFlight
            </h2>
            <p>
              Caduceus is built on top of <strong className="text-[#D4A017]">OpsFlight</strong>, a flight simulator
              for AI agents that generates realistic production environments. OpsFlight was developed as part of the
              Harmonic project — an initiative to create agents that can handle real operational workloads.
            </p>
            <p>
              The pipeline: OpsFlight generates scenarios → agents produce trajectories → Caduceus evaluates
              and ranks them. This creates a tight feedback loop: better benchmarks lead to better training
              data, which leads to better agents.
            </p>
            ...
            <ul className="space-y-2">
              <li className="flex gap-3">
                ...
                <span>Core evaluation engine with 6 scoring dimensions and public leaderboard</span>
              </li>
              <li className="flex gap-3">

...
export const LEADERBOARD_DATA: AgentEntry[] = [
  // --- Large / API models ---
  {
    ...
    fineTuned: true, quantization: "BF16",
  ...
  },
  {
    ...
    fineTuned: false, quantization: "FP8",
  ...
  },
  {
    ...
    fineTuned: false, quantization: "BF16",
  ...
  // --- Quantized runners ---
  {
    ...
    fineTuned: true, quantization: "Q5_K_M",
  ...
  },
  {
    ...
    fineTuned: false, quantization: "NVFP4",
  ...
  },
  {
    ...
    fineTuned: true, quantization: "Q4_K_M",
  ...
  },
  {
    ...
    fineTuned: true, quantization: "1-bit",

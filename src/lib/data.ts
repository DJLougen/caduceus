...
export const TASKS_DATA: TaskEntry[] = [
  ...
  { id: "T014", name: "Aether Notes – Golden Spec SaaS Website", domain: "Web & API", difficulty: "Hard", description: "Build a fully functional 5-page SaaS website from a locked golden spec. Dark/light mode, WCAG 2.2 AA, reactive pricing toggle, testimonial carousel, blog search, and mock dashboard — vanilla HTML/CSS/JS + Tailwind CDN only. Zero creative deviations.", tools: ["terminal", "read_file", "patch", "execute_code"], avgScore: 0, totalRuns: 0, source: "https://github.com/DJLougen/t014-aether-notes" },
  // Casual Arena tasks
